  ...
  <div>
    ...
    <div class="tableContainer">
      <div class="operations">
        <el-button type="primary" size="small" @click="setdialog=true">{{ $t('userful.categoryset') }}</el-button>
        <el-button type="primary" size="small" @click="downloadfile">{{ $t('message.download') }}</el-button>
        <el-button type="primary" size="small" @click="importdialog=true">{{ $t('userful.import') }}</el-button>
        <el-button type="primary" size="small" @click="download">{{ $t('userful.export') }}</el-button>
        <el-button type="primary" size="small" @click="handleAdd">{{ $t('userful.additem') }}</el-button>
      </div>
