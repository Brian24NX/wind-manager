export default {
  ...
  forgetForm: {
    ...
    requirerule: '密码必须包含至少1个数字，1个大写字母和1个小写字母，长度至少6~20位。',
    requirerules: '密码必须包含至少1个数字，1个大写字母和1个小写字母，长度至少6~20位',
    verifycode: '验证码',
    password: '新密码',
  ...
  addArticle: {
    ...
    creatortips: '作者必填',
    creatorlengthtips: '长度在 2 到 100 个字符',
